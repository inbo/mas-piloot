...
- **ontoegankelijkheid**: beek, (on)bereikbaar, (on)toegankelijk, E40, sporen, fietspad, grote baan, langs water, pad, privé, serres, snelweg, verboden
- **specifieke obstructies voor zichtbaarheid**: boomgaard, bos, haag holle weg, in put, ingesloten, talud
...
pattern3 <- "holle weg|Holleweg|talud|haag|boomgaard|bos|in put|ingesloten"
# Patroon overlap
...
issue_cat <- issues %>%
  ...
  mutate(
    ...
    reden = case_when(
      match %in% c("E40", "E40 en sporen", "privé", "(on)toegankelijk", 
                   "verboden", "grote baan", "(on)bereikbaar", "snelweg", 
                   "fietspad", "pad", "beek", "langs water", "serres") ~ 
        "ontoegankelijk",
      match %in% c("holle weg", "talud", "haag", "ingesloten", 
                   "boomgaard", "bos", "in put") ~ 
...
Zo krijgen we een algemeen overzicht waar de belangrijkste problemen zitten:
