...
hexagon_vertices <- function(radius) {
...
hexagon_data <- hexagon_vertices(radius)
...
# Plot hexagon and circumscribed circle
ggplot() +
  geom_polygon(data = hexagon_data, aes(x, y), fill = "lightblue", color = "black") +
  geom_path(data = circle_data, aes(x, y), color = "red", size = 1) +
  coord_equal() +
  xlim(-400, 400) +
  ylim(-400, 400) +
  ggtitle("Hexagon and Circumscribed Circle")
```
