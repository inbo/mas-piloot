...
We maken een grid met cellen van met dezelfde oppervlakte als de telcirkels en leggen deze over het steekproefkader (met buffer van 300 m).
...
p_veldleeuwerik1 <- plot_veldleeuwerik %>%
  ggplot() +
    ...
    geom_raster(aes(x = x_plot, y = y_plot, fill = Estimate),
                interpolate = TRUE) +
    scale_fill_gradientn(colours = c("darkblue", "lightblue", "gold", "red"),
...
p_veldleeuwerik2 <- plot_veldleeuwerik %>%
  ...
  geom_sf(data = perimeter_ol, fill = "lightgrey", colour = "darkgrey",
    ...
    geom_raster(aes(x = x_plot, y = y_plot, fill = Estimate),
                interpolate = TRUE) +
    scale_fill_gradientn(colours = c("darkblue", "lightblue", "gold", "orange",
                                     "red"),
                         breaks = c(0, 5, 10, 15, 20),
                         limits = c(0, 20)) +
    coord_sf(crs = 31370) +
