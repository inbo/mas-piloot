...
leafsync::sync(
  ...
  leaflet::addControl(m3@map, "Aantal broedparen Veldleeuwerik per 100 ha",
                      position = "bottomleft"),
  leaflet::addControl(m4@map, "Aantal broedparen Veldleeuwerik per 100 ha",
                      position = "bottomleft"))
```
...
leafsync::sync(
  ...
  leaflet::addControl(m3@map, "Aantal broedparen Gele kwikstaart per 100 ha",
                      position = "bottomleft"),
  leaflet::addControl(m4@map, "Aantal broedparen Gele kwikstaart per 100 ha",
                      position = "bottomleft"))
```
...
leafsync::sync(
  ...
  leaflet::addControl(m3@map, "Aantal broedparen Geelgors per 100 ha",
                      position = "bottomleft"),
  leaflet::addControl(m4@map, "Aantal broedparen Geelgors per 100 ha",
                      position = "bottomleft"))
```
