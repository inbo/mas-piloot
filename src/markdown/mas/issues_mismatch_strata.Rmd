...
Controle telpunt coördinaten? Lijkt geen probleem (gaat wellicht om verschillen van kleiner dan 0.01 m). Maar wel iets om mee rekening te houden.
...
De telpunten waar er problemen zijn met distance2plot zijn verplaatst!
...
```{r eval=FALSE}
issue_list_raw %>%
  filter(grepl("behouden", beslissing)) %>%
