...
```{r, include=FALSE}
schatting_soorten1 <- round(
  sum_soorten1$fixed["statusvrijwilliger", "Estimate"], 3)
ll_soorten1 <- round(
  sum_soorten1$fixed["statusvrijwilliger", "l-95% CI"], 3)
ul_soorten1 <- round(
  sum_soorten1$fixed["statusvrijwilliger", "u-95% CI"], 3)
sign_soorten1 <- ifelse(schatting_soorten1 > 0, "meer", "minder")
```
