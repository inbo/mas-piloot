...
Verdere exploratie maakte duidelijk dat dit verschil in aantal soorten gelijkaardig is voor broedcode nul en broedcode groter dan nul (95 %  CI: `r effect_broed$hypothesis$CI.Lower` tot `r effect_broed$hypothesis$CI.Upper`). Model fit was niet ideaal en in werkelijkheid verwachten we zelfs dat het verschil in aantal soorten bij broedcode 0 nog lager ligt in vergelijking met het verschil bij broedcode groter dan 0 omdat het aantal nultellingen door het model onderschat werd. We hebben dus zeker geen bewijs dat er compensatie zou zijn bij de vrijwilligers waarbij ze wel meer soorten zouden zien bij broedcode 0, maar minder bij broedcode > 0.
