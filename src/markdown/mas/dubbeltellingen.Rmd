...
Mogelijks is er ook een verschil op de manier waarop broedcodes worden toegekend door de professionele teller vs de vrijwilligers.
...
De verschilfrequenties verschillen licht, maar we zien nog altijd vrij grote verschillen (bv. Merel).
...
Zowel voor broedcode 0 als broedcode groter dan 0 zien we dat de professionele teller meer soorten ziet dan de vrijwilligers (95% CI resp. `r ll_soorten2_broed_nul * 100` - `r ul_soorten2_broed_nul * 100` % en `r ll_soorten2_broed_groot` - `r ul_soorten2_broed__groot * 100` % verschil). Model fit was echter niet ideaal, maar gebasseerd op de  posterior predictive check zou het verschil in werkelijkheid zelfs nog extremer zijn (onderschatting aantal nullen door model).
