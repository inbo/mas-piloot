...
Is er een verschil in tussen de broedcodes over status heen?

$$
\frac{1}{2}\beta_0 + \frac{1}{2}(\beta_0 + \beta_1) =  + \frac{1}{2}(\beta_0 + \beta_2) + \frac{1}{2}(\beta_0 + \beta_1 + \beta_2 + \beta_3)\\
\Rightarrow \beta_0 + \frac{1}{2}\beta_1 = \beta_0 + \frac{1}{2}\beta_1 + \beta_2 + \frac{1}{2}\beta_3\\
\Rightarrow \beta_2 + \frac{1}{2}\beta_3= 0
$$

```{r}
effect_broed <- hypothesis(
  x = fit_dubbel_soorten_pois2,
  "broedcode.L +  (1/2) * statusvrijwilliger:broedcode.L = 0",
  class = "b", alpha = 0.05)
