...
Voor de voorteelten is er bijna geen data. We creeëren wel een variabele of voorteelt aan- of afwezig is.

```{r}
bivar_vars <- setdiff(c(plot_vars, plotjaar_vars, telling_vars), exclude_hfdtlt)
