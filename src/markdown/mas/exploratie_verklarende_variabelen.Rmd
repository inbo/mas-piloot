...
```{r}
q3_hfdtlt <- c("andere_hfdtlt", "braakland_hfdtlt", "andere_graangewassen_hfdtlt",
...
-  `andere_graangewassen_hfdtlt` en `zomergranen_hfdtlt`: belangrijk voor vogels, we tellen ze samen op onder `zomergranen_hfdtlt2`
...
Er blijven nog altijd een aantal correlaties over.

Visualisatie via PCA.
We verwijderen de variabelen hoofdteelt van het jaar ervoor.
