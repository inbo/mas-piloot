...
Pearsons correlatie (lineair verband). De Pearson correlatie tussen twee variabelen zal hoog zijn wanneer waarnemingen een positief lineair verband vertonen en laag wanneer ze een positief lineair verband vertonen.

```{r}
corrplot(cor(continue_bivariate, method = "pearson"), method =  "circle",
...
```{r}
corrplot(cor(continue_bivariate, method = "spearman"), method =  "circle",
         tl.col =  "black", tl.srt = 45, tl.cex = 0.7)
```
