...
df_count_list_oltotal_raw$Geelgors %>% 
  distinct(jaar, plotnaam) %>%
  nrow()

df_count_list_oltotal_raw$GeleKwikstaart %>%
  count(jaar, plotnaam) %>%
  arrange(desc(n), plotnaam)

df_count_list_oltotal_raw$Geelgors %>% View()
