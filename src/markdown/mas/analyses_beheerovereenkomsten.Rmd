...
mod_final_dmpropsb_list <- list(
  mod_final_zip_dmpropsb_list$Geelgors,
  mod_final_pois_dmpropsb_list$GeleKwikstaart,
  mod_final_pois_dmpropsb_list$Grasmus,
  mod_final_zip_dmpropsb_list$Kievit,
  mod_final_pois_dmpropsb_list$Kneu,
  mod_final_pois_dmpropsb_list$Kwartel,
  mod_final_pois_dmpropsb_list$Torenvalk,
  mod_final_pois_dmpropsb_list$Veldleeuwerik,
  mod_final_pois_dmpropsb_list$WitteKwikstaart
  )
names(mod_final_dmpropsb_list) <- names(predictors_dmpropsb_new_list)
```
