...
if (!file.exists(paste0(model_path, "fit_sbp_gelekwik_pois1"))) {
  ...
  fit_sbp_gelekwik_pois1 <- readRDS(paste0(model_path, "fit_sbp_gelekwik_pois1.rds"))
  fit_sbp_gelekwik_negbin1 <- readRDS(paste0(model_path, "fit_sbp_gelekwik_negbin1.rds"))
  fit_sbp_gelekwik_ZIP1 <- readRDS(paste0(model_path, "fit_sbp_gelekwik_ZIP1.rds"))
  fit_sbp_gelekwik_ZINB1 <- readRDS(paste0(model_path, "fit_sbp_gelekwik_ZINB1.rds"))
}
```
