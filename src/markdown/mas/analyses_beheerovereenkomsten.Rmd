...
```{r}
size_decided_dmpropsb_new_list <- list(4, 5, 7, NA, 14, 5, 13, 3, 8, 6)
...
mod_final_oltotal_list <- list(
  mod_final_zip_oltotal_list$Geelgors,
  mod_final_pois_oltotal_list$GeleKwikstaart,
  mod_final_pois_oltotal_list$Grasmus,
  mod_final_zip_oltotal_list$Kievit,
