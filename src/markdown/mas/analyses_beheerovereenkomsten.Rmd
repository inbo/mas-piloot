...
PPVS met de default R2D2 prior is het snelst. Zonder shrinkage prior gaat het trager en de resultaten verschillen ook van deze met de R2D2 prior.

We zien dat de "mean log predictive density" (MLPD) van de R2D2 submodellen vooral hard toeneemt bij de eerste vier predictors. Daarna zijn er slechts kleine verschillen.
