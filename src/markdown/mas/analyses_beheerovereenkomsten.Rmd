...
mod_final_olsbp_list <- list(
  ...
  mod_final_zip_olsbp_list$Kneu,
  mod_final_zip_olsbp_list$Kwartel,
...
mod_final_olpropsb_list <- list(
  ...
  mod_final_zip_olpropsb_list$Kneu,
  mod_final_pois_olpropsb_list$Kwartel,
  mod_final_zip_olpropsb_list$Torenvalk,
...
```{r}
spec <- "Geelgors"
draws_olpropsb_list[[spec]] %>%
  ggplot(aes(y = area_prop_sb_cat)) +
    ...
    geom_hline(yintercept = c(min_threshold, max_threshold),
               linetype = "dotdash") +
    geom_errorbar(aes(xmin = lcl_log, xmax = ucl_log),
                  linewidth = 1, colour = "black", width = 0.1) +
    geom_point(aes(x = median_log),
    ...
    scale_x_continuous(
      ...
      sec.axis = sec_axis(~ exp(.),
        ...
        name = "Proportionele wijziging t.o.v. nulbeleid")
      ) +
    theme(
