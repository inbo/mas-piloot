...
De aangeraden grootte door het **projpred** package is `r suggest_size(cvvs_refmodel1, stat = "mlpd")` verklarende variabelen. Het gaat dan om de volgende variabelen:
  ...
  for (i in seq_along(doel_soorten_ol_pre)) {
    ...
    mas_data_df_out <- mas_data_df_agg %>%
      ...
      mutate(area_prop_sb_cat = case_when(
        ...
        area_prop_sb_cat = relevel(factor(area_prop_sb_cat), "area_0"))
...
Voor de totaalanalyse beschouwen we alle plots van 2018-2021 en voegen enkel plots van 2022 toe als ze minstens eenmaal geteld zijn in een van de voorgaande jaren (cf. distance sampling analyses). `jaar` zal een extra variabele zijn (als factor). We voeren de PPVS uit zonder restricties.
