...
We fitten half-normal en hazard-rate key functions waarbij we alle combinaties van covariaten beschouwen. Ook interacties ...
...
for (m in fitted_models) {
  ...
  test <- c(test, paste0("dens_jaren_", suffix))
}
```
...
plot(dens_jaren_hr0, pdf = TRUE)
```

```{r}
summary(dens_jaren_hr0)
```
