...
summarize_ds_models(dens_jaren_hn0, dens_jaren_hr0, dens_jaren_hn1, 
                    ...
                    dens_jaren_hn21, dens_jaren_hr21, dens_jaren_hn24) %>%
  kable()
```

Het beste model heeft variabelen regio en jaar. Als oefening selecteren we het Hazard-rate model met variabelen jaar en sbp in interactie.
