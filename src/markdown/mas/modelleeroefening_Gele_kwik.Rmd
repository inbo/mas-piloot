...
```{r}
set.seed(20221202)
df_territoria_2018$cluster <- paste(territoria_cluster(df_territoria_2018,
                                    fusie_afstand_lang), 2018, sep = "_")
df_territoria_2019$cluster <- paste(territoria_cluster(df_territoria_2019,
                                    fusie_afstand_lang), 2019, sep = "_")
df_territoria_2020$cluster <- paste(territoria_cluster(df_territoria_2020,
                                    fusie_afstand_lang), 2020, sep = "_")
df_territoria_2021$cluster <- paste(territoria_cluster(df_territoria_2021,
                                    fusie_afstand_lang), 2021, sep = "_")
df_territoria_2022$cluster <- paste(territoria_cluster(df_territoria_2022,
                                    fusie_afstand_lang), 2022, sep = "_")
...
mapview(telpunten_2018_2021 %>% st_buffer(300), 
        legend = FALSE, col.regions = "green", alpha.region = 0.1) +
mapview(telpunten_2022 %>% st_buffer(300), 
        legend = FALSE, col.regions = "green", alpha.region = 0.1) +
