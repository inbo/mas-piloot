...
Testen van een hypothese. Voorbeeld: Is het gemiddeld aantal Gele kwikstaarten significant lager in de Oostelijke leemstreek dan in De Moeren?
...
p_pois1 <- plot(pred, plot = FALSE)[[1]] + 
                scale_y_continuous(sec.axis = sec_axis( ~. / cirkelopp * 1e6, 
                  name = ""), limits = c(0, 0.4)) +
                labs(y = "Aantal Gele kwikstaarten", x = "", 
...
dsmodelunif1 <- ds(data = gele_kwik_2022_ds, key = "unif", truncation = 300, 
                 transect = "point", dht_group = FALSE, region_table = reg_tab,
...
dsmodelhn2 <- ds(data = gele_kwik_2022_ds, key = "hn", formula = ~ Region.Label,
                 adjustment = NULL, truncation = 300, transect = "point", 
                 dht_group = FALSE, region_table = reg_tab,
                 convert_units = conversion_factor)
...
dsmodelhn4 <- ds(data = gele_kwik_2022_ds, key = "hn", 
                 formula = ~ Region.Label + periode_in_jaar,
                 adjustment = NULL, truncation = 300, transect = "point", 
                 dht_group = FALSE, region_table = reg_tab,
                 convert_units = conversion_factor)
...
dsmodelhr2 <- ds(data = gele_kwik_2022_ds, key = "hr", formula = ~ Region.Label,
                 adjustment = NULL, truncation = 300, transect = "point", 
                 dht_group = FALSE, region_table = reg_tab,
                 convert_units = conversion_factor)
...
Andere covariaten die invloed zouden kunnen hebben op de detectiekans zijn voorlopig niet beschouwd (ervaring, visibiliteit, uur na zonsopkomst ...?).
