...
```{r}
plots_per_regio <- gele_kwik_2022_distance %>% 
                     group_by(regio) %>% 
...
We kiezen er echter voor om diameter van de telcirkel (600 m) als fusieafstand te nemen. We vermoeden dat dit een iets lager aantal koppels zal opleveren dan de maxima te nemen over de telperiodes indien de telcirkels overlappen of op minder dan 600 m verwijderd zijn van elkaar. Bovendien lijkt het een elegante manier om deze strategie toe te passen op ons design.
