...
# Detectiekans en densiteit verschillen per regio en soortbeschermingszone
# en openheid landschap
um_model_hn13 <- distsamp(formula = ~regio + sbp + openheid~regio + sbp + openheid, 
                          data = umf, keyfun = "halfnorm", output = "density",
         unitsOut = "kmsq")
um_model_hr13 <- distsamp(formula = ~regio + sbp + openheid~regio + sbp + openheid, 
                          data = umf, keyfun = "hazard", output = "density",
         unitsOut = "kmsq")
```
...
# Detectiekans verschilt per soortbeschermingszone in interactie met openheid landschap
# Densiteit verschilt per soortbeschermingszone in interactie met openheid landschap
...
\textcolour{red}{Hoe kunnen we hiermee rekening houden?}
Ook werd er geen rekening gehouden met de verschillende telperiodes.



met telperiodes? gdistsamp
...
test <- gdistsamp(~1,~1,~1, data = umf2, keyfun = "halfnorm", output = "density",
                  unitsOut = "kmsq", mixture = "P")
test2 <- gdistsamp(~1,~1,~1, data = umf2, keyfun = "halfnorm", output = "density",
                  unitsOut = "kmsq", mixture = "NB")
test3 <- gdistsamp(~openheid,~1,~sbp, data = umf2, keyfun = "halfnorm", output = "density",
                  unitsOut = "kmsq", mixture = "P")
test4 <- gdistsamp(~openheid,~1,~sbp, data = umf2, keyfun = "halfnorm", output = "density",
                  unitsOut = "kmsq", mixture = "NB")
```
