...
ggplot() + 
  ...
  geom_line(data = data.frame(x = distances, y = y.val0), 
            aes(x = x, y = y), colour = "blue") + # Factor level 0
  geom_line(data = data.frame(x = distances, y = y.val1), 
            aes(x = x, y = y), colour = "darkgreen") + # Factor level 1
  geom_line(data = data.frame(x = distances, y = y.val2), 
            aes(x = x, y = y), colour = "brown") + # Factor level 2
  geom_line(data = data.frame(x = distances, y = y.val3), 
            aes(x = x, y = y), colour = "salmon") + # Factor level 3
  geom_line(data = data.frame(x = distances, y = y.val4), 
            aes(x = x, y = y), colour = "black", size = 1) + # Gemiddelde
  xlab("Afstand (m)") +
  ylab("Detectiekans")
```
