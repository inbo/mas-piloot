...
```{r}
pp_check(brmpois, type = "bars_grouped", ndraws = 100, group = "regio",
...
```{r}
pp_check(brmnegbin, type = "bars_grouped", ndraws = 100, group = "regio",
         facet_args = list(ncol = 1, scales = "free_y"))
```
...
```{r}
pp_check(brmZIP, type = "bars_grouped", ndraws = 100, group = "regio",
         facet_args = list(ncol = 1, scales = "free_y"))
```


```{r}
pp_check(brmZINB, type = "bars_grouped", ndraws = 100, group = "regio",
         facet_args = list(ncol = 1, scales = "free_y"))
```
