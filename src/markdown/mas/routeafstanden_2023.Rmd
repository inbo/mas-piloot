...
De som van alle kortste afstanden binnen elke groep telpunten is `r sum(closest_dist$afstand)` km.
...
- alles x2 voor heen en terug
  - wordt automatisch berekend voor afstanden tussen twee punten
...
mapview(teller_adressen, zcol = "stad", layer = "stad")
```
