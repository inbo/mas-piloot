...
Omdat we nu een nieuwe laag van SBZ gebruiken, moeten we dit stratum opnieuw berekenen voor de bestaande punten.
Er zijn een aantal punten die overlappen voorminstens 50 %.
...
intersect <- st_intersection(oude_cirkels, cirkels_zandleemstreek) %>% 
