...
In de Westelijke leemstreek zijn ***???*** punten gevonden die niet mogelijk zijn om te tellen (track verdwenen).  
...
Uiteindelijk moeten we tot een CSV komen waarbij enkel de punten *behouden* van de eerste batch en *vervanging* van de reserve batch geüpload worden in Avimap (met tellerscode erbij).
