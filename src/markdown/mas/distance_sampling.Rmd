...
Vanaf model selectie en fit zal geen of beperkte automatisatie meer kunnen toegepast worden.
...
We voegen ook Haas toe en roofvogels (`r roofvogels`) zonder broedcodes.
...
We maken in een for-loop een dataframe voor elke soort waar we ook filteren op de datumgrenzen. Voor Haas behouden we alle telperiodes. Voor de roofvogels berekenen we de densiteiten zowel rekening houdend met broedcodes en datumgrenzen als zonder hiermee rekening te houden.
...
We beschouwen alle plots van 2018-2021 en voegen enkel plots van 2022 toe als ze minstens eenmaal geteld zijn in een van de voorgaande jaren.
We zetten alle datasets om om te gebruiken om de detectiecurve te fitten.
...
We beschouwen alle plots van 2022.
We filteren alle datasets om te gebruiken om de detectiecurve te fitten.
...
> Als we deze getallen aanpassen, moeten de modellen die verderop gefit worden worden verwijderd uit de lokale folder anders zullen de oude modellen geladen worden.
...
In de complexe dataset zijn de meeste soorten in meerdere jaren gezien.
...
final_models_complex <- list(
  ...
  Kneu = Kneu_distmod_2018_2022_hn1,
...
```{r}
final_models <- list(
  Blauwborst = Blauwborst_distmod_2018_2022_hr1_simpel,
  ...
  Kneu = Kneu_distmod_2018_2022_hn1_simpel,
  ...
  Roek = Roek_distmod_2018_2022_hr1_simpel,
...
final_models_2022_complex <- list(
  ...
  Pimpelmees = Pimpelmees_distmod_2022_hr1,
...
final_models_2022 <- list(
  ...
  Merel = Merel_distmod_2022_hn7,
  Pimpelmees = Pimpelmees_distmod_2022_hr1_simpel,
