...
```{r}
par(mfrow = c(2, 2))
visualizeWeights(10000, m = 0.7, b = 6, mode = "exponential")
visualizeWeights(10000, m = 1, b = 6, mode = "exponential")
visualizeWeights(10000, m = 0.7, b = 12, mode = "exponential")
visualizeWeights(10000, m = 1, b = 12, mode = "exponential")
par(mfrow = c(1, 1))
```
...
```{r}
df <- tibble(dist = seq(0, 10000)) %>% 
  mutate(w = calc_weights(dist, 10000, mode = "banaan"))
ggplot(df) +
  geom_point(aes(x = dist, y = w))
```
