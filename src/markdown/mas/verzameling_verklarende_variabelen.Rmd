...
We maken zowel een variabele aan voor soortbeschermingsmaatregelen als voor de overige maatregelen.
...
## Oppervlakte-aandeel overige beschermingsmaatregelen
...
telpunten_2018_2022_bo_rest <- add_bo_by_year(
  ...
  bo_file_2022,
  bh_doel = c("beheer KLE's (KLE)",
             "erosiebestrijding (ER)",
...
summary_df <- tibble(
  categorie = "prioritair", 
  variabele = "oppervlakte-aandeel overige beschermingsmaatregelen", 
  eenheid = "proportie", 
  bron = "VLM")
```
...
telpunten_2018_2022_bo_rest %>%
  ggplot() +
    geom_histogram(aes(x = area_prop_sb)) +
    labs(
      title = "Oppervlakte-aandeel overige beschermingsmaatregelen",
      x = "Oppervlakte-aandeel",
      y = "Aantal telpunten") +
    facet_wrap(~jaar)
```
...
```{r}
aggregate(telpunten_2018_2022_bo_rest$area_prop_sb, 
