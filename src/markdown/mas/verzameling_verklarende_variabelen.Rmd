...
Belangrijkste teelten in 2022. Voorlopige kaart. Finale kaart wordt eind maart gepubliceerd.
...
calc_lbg_by_year <- function(punten_df) {
  ...
  for (i in seq_along(years)) {
    ...
    out_df_year <- calc_lbg(path = lbg_file,
                            punten_sf = telpunten_2018_2022_df)
...
telpunten_2018_2022_hfdtlt <- calc_lbg_by_year(telpunten_2018_2022_df)
```
