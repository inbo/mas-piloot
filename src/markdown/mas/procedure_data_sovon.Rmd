...
1.   open QGIS en kies `Kaartlagen` --> `Databronnen beheren` --> `WFS / OGC API objecten`
...
1.   Selecteer `Kaartlagen` --> `Opslaan als ...` en sla op als `Geojson` (of `Geopackage`) met als bestandsnaam `<YYYYMMDD_qgis_export_sovon_wfs>` en CRS `EPSG:28992`. Klik op OK (dit kan even duren).
