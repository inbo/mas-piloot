...
ggsave(here(media_folder, "soorten_mas_2022_2023.jpg"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "soorten2_mas_2018_2023.jpg"),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, "soorten3_mas_2018_2023.jpg"),
       p,
       dpi = 300,
       width = 10,
       height = 6)
...
write_csv(relfreqs_doel_2018_2023_jaar,
          here(media_folder, "relfreqs_jaar_mas_2018_2023_doel.csv"))
...
relfreqs_doel_2018_2023_jaar %>%
  ...
  mutate(verschilfreq = `De Moeren` - `Oostelijke leemstreek`) %>%
  arrange(naam) %>%
  write_csv(here(media_folder, "verschilfreq_mas_2018_2023_doel.csv"))
```
...
for (spec in sort(doelsoorten)) {
  ...
  ggsave(here(media_folder, paste0("relfreq_", name, "_mas_2018_2023.jpg")),
         p + ggtitle(""),
         dpi = 300,
         width = 8,
         height = 6)
...
for (spec in doelsoorten) {
  ...
  ggsave(here(media_folder, paste0("relfreq2_", name, "_mas_2018_2023.jpg")),
         p + ggtitle(""),
         dpi = 300,
         width = 8,
         height = 6)
...
write_csv(relfreqs_doelvogels_strat,
          here(media_folder, "relfreqs_strat_mas_2018_2023_doel.csv"))
```
...
for (spec in sort(doelsoorten)) {
  ...
  ggsave(here(media_folder, paste0("relfreq3_", name, "_mas_2018_2023.jpg")),
         p + ggtitle(""),
         dpi = 300,
         width = 8,
         height = 6)
...
ggsave(here(media_folder, paste0("soortbeschermingsmaatregelen1_2018_2023.jpg")),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
ggsave(here(media_folder, paste0("soortbeschermingsmaatregelen3_2018_2023.jpg")),
       p,
       dpi = 300,
       width = 8,
       height = 6)
...
```{r}
plot_densiteit_max(doel_vogels, bezoekenlijst_2018_2023, "Geelgors")
```
