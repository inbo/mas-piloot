...
ggsave(here(media_folder, "verschilfreq_dm_mas_2018_2023.jpg"),
       p + theme(plot.margin = unit(c(5.5, 15.5, 5.5, -10), "pt")),
       dpi = 300,
       width = 6,
       height = 10)
...
ggsave(here(media_folder, "verschilfreq_ol_mas_2018_2023.jpg"),
       p + theme(plot.margin = unit(c(5.5, 15.5, 5.5, -10), "pt")),
       dpi = 300,
       width = 6,
       height = 10)
...
p <- relfreq_diff_total %>%
  ggplot() +
    ...
    guides(colour = guide_legend(override.aes = list(size = 3))) +
    annotate("segment",
             x = c(abs(max(relfreq_diff_dm$verschilfreq))),
             y = c(length(unique(relfreq_diff_total$naam)) - 10 + 1),
             xend = c(abs(max(relfreq_diff_dm$verschilfreq))),
    ...
    annotate("text", label = c("De Moeren"),
             x = c(abs(max(relfreq_diff_dm$verschilfreq)) + 0.05),
             y = c(length(unique(relfreq_diff_total$naam)) - 10 + 1),
...
ggsave(here(media_folder, "verschilfreq_total_mas_2018_2023.jpg"),
       p + theme(plot.margin = unit(c(5.5, 15.5, 5.5, -10), "pt")),
       dpi = 300,
       width = 6,
       height = 10)
