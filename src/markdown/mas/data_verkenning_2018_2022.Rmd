...
design2022 <- mas_data_df %>%
  filter(jaar == 2022,
         openheid %in% c("HOL", "OL")) %>%
  distinct(plotnaam, regio, openheid, sbp)

# To detect absences
bezoekenlijst_2022 <- mas_data_df %>%
  filter(jaar == 2022,
         openheid %in% c("HOL", "OL")) %>%
...
Selectie van vogelsoorten waargenomen in 2022 in HOL en OL.
...
Selectie van zoogdieren waargenomen in 2022 in HOL en OL.
