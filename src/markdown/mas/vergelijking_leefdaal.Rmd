...
De perceelsgroottes in Lovenjoel zijn iets gelijkaardiger als Zavelberg dan Kortenberg (mediaan), maar het verschil tussen Kortenberg en Lovenjoel is niet zo groot. We geven daarom Kortenberg een "0" en Lovenjoel een "+".

```{r}
conclusie_df <- rbind(conclusie_df, c("perceelsgrootte", "0", "+", 
