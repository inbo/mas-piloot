...
landgebruik_leefdaal_df_unscaled <- landgebruik_leefdaal %>%
  ...
  arrange(naam)
landgebruik_leefdaal_df <- cent_log_ratio(landgebruik_leefdaal_df_unscaled)
...
hfdteelten_leefdaal_df_unscaled <- hfdteelten_leefdaal  %>%
  ...
  arrange(naam)
hfdteelten_leefdaal_df <- cent_log_ratio(hfdteelten_leefdaal_df_unscaled)
...
openheid_leefdaal_df_unscaled <- openheid_leefdaal %>%
  ...
  arrange(naam)
openheid_leefdaal_df <- cent_log_ratio(openheid_leefdaal_df_unscaled)
...
Erkenning van compositionele data betekent dat we op de relatieve en niet op absolute groottes van de componenten moeten focussen, nl. verhoudingen van de componenten. Variabelen die dicht bij elkaar liggen op de biplot zullen een meer constante ratio hebben.  
Lovenjoel ligt dichter bij Zavelberg langs PC1 en Kortenberg ligt dichter bij Zavelberg langs PC2. De log-ratio's zijn gelijkaardiger in Lovenjoel en Zavelberg dan Kortenberg en Zavelberg.
