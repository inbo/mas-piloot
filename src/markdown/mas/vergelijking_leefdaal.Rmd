...
biplot(prcomp(openheid_leefdaal_df %>%
+                   column_to_rownames(var = "naam"), center = TRUE, scale = TRUE))
...
Deze resultaten zijn in overeenstemming met onze conclusie in \@ref(openheid).
