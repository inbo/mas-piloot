...
```{r}
compostions_trans <- function(df, transformation) {
  columnnames <- df %>%
  ...
  if (transformation == "ilr") {
    ...
    stop("Transformation must be 'clr' or 'ilr'!")
  }
...
landgebruik_leefdaal_df_unscaled <- landgebruik_leefdaal %>%
  ...
  arrange(naam)
landgebruik_leefdaal_df <- compostions_trans(landgebruik_leefdaal_df_unscaled, "clr")
...
hfdteelten_leefdaal_df_unscaled <- hfdteelten_leefdaal  %>%
  ...
  arrange(naam)
hfdteelten_leefdaal_df <- compostions_trans(hfdteelten_leefdaal_df_unscaled, "clr")
...
openheid_leefdaal_df_unscaled <- openheid_leefdaal %>%
  ...
  arrange(naam)
openheid_leefdaal_df <- compostions_trans(openheid_leefdaal_df_unscaled, "clr")
