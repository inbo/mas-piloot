...
```{r}
mapview::mapview(perimeters, color = "red", alpha.regions = 0) + 
  mapview::mapview(distinct(mas_design, geometry), legend = FALSE) +
  mapview::mapview(mas_perimeters, col.regions = "gold", alpha.regions = 0.5)
```
