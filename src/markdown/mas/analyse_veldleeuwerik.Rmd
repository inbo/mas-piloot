...
De `region_table` en de conversiefactor zijn gemeenschappelijk voor alle soorten.
...
In de complexe dataset zijn de meeste soorten zijn in meerdere jaren gezien.
...
In de complexe dataset zijn de meeste soorten zijn in meerdere openheidsklasses gezien.
De meeste soorten hebben waarnemingen van slechts een enkele regio.
