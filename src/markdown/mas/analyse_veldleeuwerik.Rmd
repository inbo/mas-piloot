...
Het model waarbij de detectiekans afhankelijk is van ... scoort het best.
Op basis van dit model testen we nog enkele combinaties ...
...
De visuele fit ziet er goed uit maar Cramér-von Mises test suggereert dat het model niet goed past bij de data (...).
...
De detectiekansen en standard error worden gegeven door:
