...
De data voor Bruine kiekendief, Ekster, GroeneSpecht, Holenduif, Kievit, Koolmees en TurkseTortel passen niet voor distance sampling. Een belangrijke aanname voor distance sampling is dat de detectiekans afneemt over de afstand. Dat zien we niet voor deze soorten, waardoor we geen detectiecurve kunnen fitten.
...
distance_data <- distance_dfs_2018_2022_final[["Blauwborst"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Blauwborst"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Blauwborst"]]
Blauwborst_distmod_2022_hn1_binned <- ds(data = distance_data, key = "hn", 
  max_adjustments = 2, 
  monotonicity = "strict", cutpoints = c(0, 50, 100, 150, 200, 250, 300),
  truncation = 300, transect = "point", dht_group = FALSE, 
  convert_units = conversion_factor_2018_2022, 
  region_table = region_table_2018_2022, 
  sample_table = sample_table_2018_2022, 
...
plot(Blauwborst_distmod_2022_hn1_binned, pdf = TRUE)
plot_detection_curve(Blauwborst_distmod_2022_hn1_binned, n_breaks = 6)


distance_data <- distance_dfs_2018_2022_final[["Gaai"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Gaai"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Gaai"]]
Gaai_distmod_2022_hn1_binned <- ds(data = distance_data, key = "hn", 
  max_adjustments = 2, 
  monotonicity = "strict", cutpoints = c(0, 50, 100, 150, 200, 250, 300),
  truncation = 300, transect = "point", dht_group = FALSE, 
  convert_units = conversion_factor_2018_2022, 
...
plot(Gaai_distmod_2022_hn1_binned, pdf = TRUE)
plot_detection_curve(Gaai_distmod_2022_hn1_binned, n_breaks = 6)


distance_data <- distance_dfs_2018_2022_final[["Kwartel"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Kwartel"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Kwartel"]]
Kwartel_distmod_2022_hn1_binned <- ds(data = distance_data, key = "hn", 
  max_adjustments = 2, 
  monotonicity = "strict", cutpoints = c(0, 100, 200, 300),
  truncation = 300, transect = "point", dht_group = FALSE, 
  convert_units = conversion_factor_2018_2022, 
  region_table = region_table_2018_2022, 
  sample_table = sample_table_2018_2022, 
...
plot(Kwartel_distmod_2022_hn1_binned, pdf = TRUE)
plot_detection_curve(Kwartel_distmod_2022_hn1_binned, n_breaks = 3)


distance_data <- distance_dfs_2018_2022_final[["Patrijs"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Patrijs"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Patrijs"]]
Patrijs_distmod_2022_hn1_binned <- ds(data = distance_data, key = "hn", 
  max_adjustments = 2, 
  monotonicity = "strict", cutpoints = c(0, 50, 100, 150, 200, 250, 300),
  truncation = 300, transect = "point", dht_group = FALSE, 
  convert_units = conversion_factor_2018_2022, 
...
plot(Patrijs_distmod_2022_hn1_binned, pdf = TRUE)
plot_detection_curve(Patrijs_distmod_2022_hn1_binned, n_breaks = 6)


distance_data <- distance_dfs_2018_2022_final[["Torenvalk"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Torenvalk"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Torenvalk"]]
Torenvalk_distmod_2022_hn1_binned <- ds(data = distance_data, key = "hn", 
  max_adjustments = 2, 
  monotonicity = "strict", cutpoints = c(0, 50, 100, 150, 200, 250, 300),
  truncation = 300, transect = "point", dht_group = FALSE, 
  convert_units = conversion_factor_2018_2022, 
...
plot(Torenvalk_distmod_2022_hn1_binned, pdf = TRUE)
plot_detection_curve(Torenvalk_distmod_2022_hn1_binned, n_breaks = 6)

distance_data <- distance_dfs_2018_2022_final[["Veldleeuwerik"]]
sample_table_2018_2022 <- sample_tables_2018_2022[["Veldleeuwerik"]]
obs_table_2018_2022 <- obs_tables_2018_2022[["Veldleeuwerik"]]
Veldleeuwerik_distmod_2022_hr4_binned <- ds(data = distance_data, key = "hr", 
...
plot(Veldleeuwerik_distmod_2022_hr4_binned, pdf = TRUE)
plot_detection_curve(Veldleeuwerik_distmod_2022_hr4_binned, n_breaks = 6)
```
