...
Dat impliceert dat na selectie: Als voor een soort slechts 1 stratum overblijft (jaar, regio), zijn er minstens 20 waarnemingen. Bij twee strata zijn dit er ook minstens 20, bij 3 strata minstens 30, 4 strata minstens 40 ... In totaal zijn er 10 strata mogelijk (5 jaren, 2 regio's).
...
distance_dfs_2018_2022_final <- filter_dist_df(distance_dfs_2018_2022, 10, 20)
```
...
stratum_cijfers_lijst <- lapply(seq_along(distance_dfs_2018_2022_final), 
  function(i) {
    if (nrow(distance_dfs_2018_2022_final[[i]]) == 0) {
      out <- tibble(soort = names(distance_dfs_2018_2022_final[i]),
                    n = 0, n_jaar = 0, n_regio = 0, n_interactie = 0)
    } else {
...
# Loop over species
for (spec in names(distance_dfs_2018_2022_final)[-which(names(distance_dfs_2018_2022_final) %in% c("BruineKiekendief", "Houtduif", "Huismus", "WitteKwikstaart"))]) {
...
final_models <- list(Blauwborst = Blauwborst_distmod_2022_hn1,
                     ...
                     Graspieper = Graspieper_distmod_2022_hn1,
                     ...
                     Meerkoet = Meerkoet_distmod_2022_hn1,
                     ...
                     Tuinfluiter = Tuinfluiter_distmod_2022_hr1,
                     TurkseTortel_distmod_2022 = TurkseTortel_distmod_2022_hr1,
                     ...
                     Zanglijster = Zanglijster_distmod_2022_hr1,
