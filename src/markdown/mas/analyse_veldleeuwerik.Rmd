...
Eerst voor Veldleeuwerik. Later generalisatie.
...
Alle telperiodes bevinden zich wel binnen de datumgrenzen (maar binnen in de oude: 1 april tot 15 juni [@veldleeuwerikSovon]). We nemen alle telperiode dus mee in de analyses.
...
We zien een duidelijk verschil in densiteiten tussen de strata. Het is steeds hoger binnen dan buiten soortbeschermingszones en in OL dan in HOL.
...
Vanaf model selectie en fit zal geen of beperkte automatisatie meer kunnen toegepast worden. We selecteren voor elke soort het finale model en slaan deze op. Deze finale modellen kunnen dan in het rapport gebruikt worden voor het genereren van plots en tabellen.
...
We maken een dataframe `mas_observations` waarbij we alle waarnemingen van vogels selecteren en filteren op broedcode > 0, geen afstanden > 300 m en dat ze binnen telperiodes vallen. We behouden ook enkel de plots die tot `design_2018_2022_mas` behoren.
...
We maken in een for-loop een dataframe voor elke soort waar we ook filteren op de datumgrenzen.
...
We beschouwen alle plots van 2018-2021 en voegen enkel plots van 2022 toe als ze minstens eenmaal geteld zijn in een van de voorgaande jaren. We zetten alle datasets om om te gebruiken om de detectiecurve te fitten.
...
De `region_table` en de conversiefactor zijn gemeenschappelijk voor alle soorten. `region_table` bevat de oppervlaktes per stratum (regio-jaar).
...
region_table_2018_2022 <- design_2018_2022_mas %>%
  distinct(regio, jaar) %>%
  full_join(areas, by = "regio") %>%
  mutate(Region.Label = paste(regio, jaar, sep = " - ")) %>%
  select(Region.Label, Area)
...
Hiervoor moeten we ook rekening houden dat sommige observaties meerdere individuen bevatten. Een observatie van 2 individuen telt hier als 2 waarnemingen!
...
De meeste soorten zijn in meerdere jaren gezien. De meeste soorten hebben waarnemingen van slechts een enkele regio. Een interactie tussen regio en jaar zal slechts in een beperkt aantal gevallen gefit kunnen worden.
...
stratum_cijfers_lijst <- lapply(seq_along(distance_dfs_2018_2022_final), 
  function(i) {
    out <- distance_dfs_2018_2022_final[[i]] %>% 
      ...
      mutate(n = nrow(distance_dfs_2018_2022_final[[i]]),
...
De volgende soorten blijven over:
...
list <- lapply(seq_along(distance_dfs_2018_2022_final), 
  function(i) {
    distance_dfs_2018_2022_final[[i]] %>% 
      mutate(soort = names(distance_dfs_2018_2022_final[i])) %>%
      mutate(n_obs = nrow(distance_dfs_2018_2022_final[[i]]),
...
```{r}
final_models <- list(Blauwborst = Blauwborst_distmod_2022_hn1,
                     Buizerd = Buizerd_distmod_2022_hn1,
                     Ekster = Ekster_distmod_2022_hr1,
                     Fazant = Fazant_distmod_2022_hr1,
                     Gaai = Gaai_distmod_2022_hn1,
                     Geelgors = Geelgors_distmod_2022_hr1,
                     GeleKwikstaart = GeleKwikstaart_distmod_2022_hr3,
                     Grasmus = Grasmus_distmod_2022_hn1,
                     GrauweGors = GrauweGors_distmod_2022_hn1,
                     GroeneSpecht = GroeneSpecht_distmod_2022_hn1,
                     Heggenmus = Heggenmus_distmod_2022_hn1,
                     Holenduif = Holenduif_distmod_2022_hn1,
                     Houtduif = Houtduif_distmod_2022_hn3,
                     Huismus = Huismus_distmod_2022_hn3,
                     Kievit = Kievit_distmod_2022_hr1,
                     KleineKarekiet = KleineKarekiet_distmod_2022_hn1,
                     Kneu = Kneu_distmod_2022_hn1,
                     Koolmees = Koolmees_distmod_2022_hr1,
                     Kwartel = Kwartel_distmod_2022_hn1,
                     Merel = Merel_distmod_2022_hr1,
                     Patrijs = Patrijs_distmod_2022_hn1,
                     Rietzanger = Rietzanger_distmod_2022_hn1,
                     Spotvogel = Spotvogel_distmod_2022_hn1,
                     Spreeuw = Spreeuw_distmod_2022_hr1,
                     Tjiftjaf = Tjiftjaf_distmod_2022_hr2,
                     Torenvalk = Torenvalk_distmod_2022_hn1,
                     TurkseTortel = TurkseTortel_distmod_2022_hr1,
                     Veldleeuwerik = Veldleeuwerik_distmod_2022_hr4,
                     Vink = Vink_distmod_2022_hn1,
                     WildeEend = WildeEend_distmod_2022_hn1,
                     Winterkoning = Winterkoning_distmod_2022_hn1,
                     WitteKwikstaart = WitteKwikstaart_distmod_2022_hn1,
                     ZwarteKraai = ZwarteKraai_distmod_2022_hr1,
...
for (naam in names(final_models)) {
  ...
  if (f == "~jaar") {
    ...
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = jaar == "2018",
         main = "2018", pl.col = alpha("blue", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "blue",
      data = data.frame(jaar = "2018"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = jaar == "2019",
         main = "2019", pl.col = alpha("darkgreen", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "darkgreen",
      data = data.frame(jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = jaar == "2020",
         main = "2020", pl.col = alpha("brown", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "brown",
      data = data.frame(jaar = "2020"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = jaar == "2021",
         main = "2021", pl.col = alpha("salmon", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "salmon",
      data = data.frame(jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = jaar == "2022",
         main = "2022", pl.col = alpha("gold", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "gold",
      data = data.frame(jaar = "2022"), pdf = TRUE)
  ...
  if (f %in% c("~regio + jaar", "~regio * jaar")) {
    ...
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "De Moeren" & jaar == "2018",
         main = "De Moeren - 2018", pl.col = alpha("blue", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "blue",
      data = data.frame(regio = "De Moeren", jaar = "2018"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "Oostelijke leemstreek" & jaar == "2018",
         main = "Oostelijke leemstreek - 2018", pl.col = alpha("darkgreen", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "darkgreen",
      data = data.frame(regio = "Oostelijke leemstreek", jaar = "2018"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "De Moeren" & jaar == "2019",
         main = "De Moeren - 2019", pl.col = alpha("darkgreen", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "darkgreen",
      data = data.frame(regio = "De Moeren", jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "Oostelijke leemstreek" & jaar == "2019",
         main = "Oostelijke leemstreek - 2019", pl.col = alpha("darkgreen", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "darkgreen",
      data = data.frame(regio = "Oostelijke leemstreek", jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "De Moeren" & jaar == "2020",
         main = "De Moeren - 2020", pl.col = alpha("brown", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "brown",
      data = data.frame(regio = "De Moeren", jaar = "2020"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "Oostelijke leemstreek" & jaar == "2020",
         main = "Oostelijke leemstreek - 2020", pl.col = alpha("brown", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "brown",
      data = data.frame(regio = "Oostelijke leemstreek", jaar = "2020"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "De Moeren" & jaar == "2021",
         main = "De Moeren - 2021", pl.col = alpha("salmon", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "salmon",
      data = data.frame(regio = "De Moeren", jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "Oostelijke leemstreek" & jaar == "2021",
         main = "Oostelijke leemstreek - 2021", pl.col = alpha("salmon", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "salmon",
      data = data.frame(regio = "Oostelijke leemstreek", jaar = "2019"), pdf = TRUE)
    
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "De Moeren" & jaar == "2022",
         main = "De Moeren - 2022", pl.col = alpha("gold", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "gold",
      data = data.frame(regio = "De Moeren", jaar = "2022"), pdf = TRUE)
  
    plot(ds_model_2018_2022, pdf = TRUE, showpoints = FALSE,
         subset = regio == "Oostelijke leemstreek" & jaar == "2022",
         main = "Oostelijke leemstreek - 2022", pl.col = alpha("gold", 0.5))
    add.df.covar.line(ds_model_2018_2022, lwd = 3, lty = 1, col = "gold",
      data = data.frame(regio = "Oostelijke leemstreek", jaar = "2022"), pdf = TRUE)
...
De data voor BruineKiekendief, Ekster, GroeneSpecht, Holenduif, Kievit, Koolmees en TurkseTortel passen niet voor distance sampling. Een belangrijke aanname voor distance sampling is dat de detectiekans afneemt over de afstand. Dat zien we niet voor deze soorten, waardoor we geen detectiecurve kunnen fitten.

```{r}
spec_to_remove <- c("Ekster", "GroeneSpecht", "Holenduif", 
                    "Kievit", "Koolmees", "TurkseTortel")
...
De detectiekans voor Blauwborst, Gaai, Kwartel, Patrijs, Torenvalk, Veldleeuwerik neemt soms weer toe na een bepaalde afstand. Voor deze soorten groeperen we de afstanden per 100 meter voor Kwartel en 50 meter voor de andere soorten. 
...
We hebben de densiteiten kunnen schatten van `r length(final_models_update)` soorten. De volgende tabel geeft een overzicht van de soorten en modellen die gefit zijn.
...
results <- lapply(seq_along(final_models_update), 
  function(i) {
    ...
    p <- ds_model$dht$individuals$average.p
