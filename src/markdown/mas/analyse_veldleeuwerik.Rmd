...
for (spec in names(distance_dfs_2018_2022_simpel_new)) {
  ...
  for (k in keys) {
    # Naam voor model
    mod_name <- paste0(spec, "_distmod_2018_2022_", k, i, "_simpel")
    file <- paste0(model_path, mod_name, ".rds")
...
```{r}
final_models <- list(Blauwborst = Blauwborst_distmod_2018_2022_hr1_simpel,
                     Bosretzanger = Bosrietzanger_distmod_2018_2022_hn1_simpel,
                     ...
                     Spreeuw = Spreeuw_distmod_2018_2022_hr1_hn1_simpel,
                     Tjiftjaf = Tjiftjaf_distmod_2018_2022_hr2,
...
De data voor BruineKiekendief, GroeneSpecht en Roek passen niet voor distance sampling.
...
```{r}
spec_to_remove <- c("GroeneSpecht", "Kauw", "Roek")
...
De detectiekans voor Blauwborst, Haas, Kwartel, Patrijs, Torenvalk, Veldleeuwerik neemt soms weer toe na een bepaalde afstand.
