...
```{r}
datumgrenzen <- read_csv2(here("data", "SOVON", 
...
datumgrenzen <- datumgrenzen %>%
  ...
  mutate(Datum_begin_maand = match(Datum_begin_maand, trans_vec),
         datum_begin = paste(Datum_begin_dag, Datum_begin_maand, sep = "/")) %>%
  mutate(Datum_eind_maand = match(Datum_eind_maand, trans_vec),
         datum_eind = paste(Datum_eind_dag, Datum_eind_maand, sep = "/")) %>%
  mutate(Datum_begin_maand_oud = match(Datum_begin_maand_oud, trans_vec),
         datum_begin_oud = paste(Datum_begin_dag_oud, Datum_begin_maand_oud, 
                                 sep = "/")) %>%
  mutate(Datum_eind_maand_oud = match(Datum_eind_maand_oud, trans_vec),
         datum_eind_oud = paste(Datum_eind_dag_oud, Datum_eind_maand_oud, 
                                sep = "/")) %>%
