...
final_models <- list(Blauwborst = Blauwborst_distmod_2022_hn1,
                     ...
                     Holenduif = Holenduif_distmod_2022_hr2,
...
De data voor BruineKiekendief en GroeneSpecht passen niet voor distance sampling. Een belangrijke aanname voor distance sampling is dat de detectiekans afneemt over de afstand. Dat zien we niet voor deze soorten, waardoor we geen detectiecurve kunnen fitten.

```{r}
spec_to_remove <- c("GroeneSpecht")
