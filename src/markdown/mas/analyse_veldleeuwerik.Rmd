...
veldleeuwerik_dist_2018_2022_hr22 <- ds(data = veldleeuwerik_distance, key = "hr", 
...
summarize_ds_models2(
  veldleeuwerik_dist_2018_2022_hr9, veldleeuwerik_dist_2018_2022_hr19,
  veldleeuwerik_dist_2018_2022_hr21, veldleeuwerik_dist_2018_2022_hr22, veldleeuwerik_dist_2018_2022_hr23,
  veldleeuwerik_dist_2018_2022_hr24
  ) %>%
  kable()
```
...
```{r}
par(mfrow = c(1, 2))
von_mises <- gof_ds(veldleeuwerik_dist_2018_2022_hr22)
von_mises
plot(veldleeuwerik_dist_2018_2022_hr22, pdf = TRUE, showpoints = FALSE)
par(mfrow = c(1, 1))
```
...
```{r}
plot_detection_curve(veldleeuwerik_dist_2018_2022_hr22, plot_average_fit = FALSE, 
                     n_breaks = 60)
```
...
```{r, cache=TRUE}
veldleeuwerik_dist_2018_2022_hr22_binned <- ds(data = veldleeuwerik_distance, key = "hr", 
        formula = ~sbp*jaar + openheid, adjustment = NULL, truncation = 300, 
        transect = "point", dht_group = FALSE, 
...
```{r}
plot(veldleeuwerik_dist_2018_2022_hr22_binned, pdf = TRUE, showpoints = FALSE)
```
...
```{r}
veldleeuwerik_dist_2018_2022_model <- veldleeuwerik_dist_2018_2022_hr22_binned
