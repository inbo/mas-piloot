...
De volgende hazard-rate modellen konden niet gefit worden:
...
model_selection <- summarize_ds_models(
  ...
  veldleeuwerik_dist_hr11, veldleeuwerik_dist_hn12,
  veldleeuwerik_dist_hn13, veldleeuwerik_dist_hn14, 
  veldleeuwerik_dist_hr14, veldleeuwerik_dist_hn15, 
  veldleeuwerik_dist_hn16, veldleeuwerik_dist_hn17, 
  veldleeuwerik_dist_hr17, veldleeuwerik_dist_hn18, veldleeuwerik_dist_hr18, 
  veldleeuwerik_dist_hn19, veldleeuwerik_dist_hr19, 
  veldleeuwerik_dist_hn20
  )
model_selection %>%
  kable()
```
...
veldleeuwerik_dist_hr24 <- ds(data = veldleeuwerik_distance, key = "hr", 
...
summarize_ds_models(
  veldleeuwerik_dist_hr9, veldleeuwerik_dist_hr19,
  veldleeuwerik_dist_hr21, veldleeuwerik_dist_hr22, veldleeuwerik_dist_hr23,
  veldleeuwerik_dist_hr24
  ) %>%
  kable()
```
...
We hebben de studieregio in 2$\times$5 strata opgesplits: elk jaar voor De Moeren en de Oostelijke leemstreek.
...
De oppervlakte zal niet wijzigen over dejaren maar enkel tussen de regio's.
...
De gemiddelde detectiekans $\hat{P}_a$ is gelijk aan `r round(veldleeuwerik_dist_model$dht$individuals$average.p, digits = 3)`
...
Veldleeuwerikken vliegen gemakkelijk op bij verstoring waardoor we minder waarnemingen zien op kleinere afstanden en dan weer een groter aantal zien rond ca. 75-100 m. 
...
We kunnen deze resultaten vergelijken met andere technieken. Het gemiddelde en het maximum aantal en broedparen over de telperiodes. Opgeteld per jaar en per regio. Omgerekend naar densiteit door te delen door de bezochte oppervlakte. Voor het gemiddelde is ook met absensies rekening gehouden (maakt voor maximum niet uit). De gemiddeldes liggen lager, terwijl de maxima goed overeenkomen met de resultaten van distance sampling. In de volgende figuur zijn de gemiddeldes en maxima aangegeven door bar-plots en waarbij de resultaten van distance sampling erover zijn geplot. 
