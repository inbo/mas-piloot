...
5.  Model specificatie distance sampling
...
selectie 
```{r}
distance_dfs_2018_2022[sapply(distance_dfs_2018_2022, nrow) >= 30]
```
...
# Loop over species
for (soort in names(distance_dfs_2018_2022)) {
  distance_data <- distance_dfs_2018_2022[[soort]]
