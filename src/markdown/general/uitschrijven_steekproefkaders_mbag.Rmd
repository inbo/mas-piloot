...
Verdere controle en overleg toonde nog drie punten die niet geteld worden en moeten vervangen worden:
...
final_points_ol <- final_points_ol[
  -which(final_points_ol %in% c("Ol_815.5", "Ol_5760.2.14", "Ol_2025.4"))
]
```
