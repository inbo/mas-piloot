...
list(
  ...
  tar_target(
    punten_steekproefkader_zichtbaarheid,
    filter_zichtbaarheid(sample = punten_steekproefkader,
                         min_cvvi = 0.1,
                         resolution = 5,
                         spacing = 10),
...
list(
  tar_target(
    ...
    command = add_bo_to_frame(
      punten_df = punten_steekproefkader_zichtbaarheid,
      path_bo = bo_file),
    pattern = map(punten_steekproefkader_zichtbaarheid)
    ),
  tar_target(
    name = lbg_statistics,
