...
#> ward
<!--
Functie aangepast. Indien je geen landuse of leisure wilt uitsluiten moet je NULL ingeven bij die variabele! Anders ga je automatisch de defaults uitsluiten.

Landgebruiken extra uit te sluiten:
-Buffer van 50m rond snelwegen, treinsporen ... gebruiken (uitsluiten)
- zie ontoegankelijk issues_pilootmeetnet.Rmd
  -  serres: landuse = greenhouse_horticulture (niet aanwezig in zavelberg)
