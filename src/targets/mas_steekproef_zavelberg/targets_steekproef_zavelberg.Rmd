...
list(
  ...
  tar_target(
    punten_zichtbaarheid,
    add_visibility_to_frame(punten_sf = punten_selectie_landgebruik,
                            resolution = 5,
                            spacing = 10),
    pattern = map(punten_selectie_landgebruik)
  ),
  tar_target(
    punten_selectie_zichtbaarheid,
    filter_zichtbaarheid(punten_sf = punten_zichtbaarheid,
                         min_cvvi = 0.1),
