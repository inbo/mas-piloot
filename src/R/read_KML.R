#' Function to properly read in KML file
#'
#' @param dsn A data source name: the character string holding the data.
#' @param layer A layer name as a character string or layer number; in case
#' layer is missing, read_KML will read the first layer of dsn
