...
Ligging van LUCAS meetpunten (selectie uit 2 km x 2 km grid) die in 2018 geïnventariseerd werden (zoals ingemeten met gps, kan afwijken van theoretisch grid):
...
Theoretisch grid: meetpunten van alle jaren:
...
Voor 2020 is dit het overzicht per gewasgroep:
...
Voorbeeldkaartje met verspreiding van GEWASGROEP = Aardappelen
...
Er is ook een [WCS service](https://www.mercator.vlaanderen.be/raadpleegdienstenmercatorpubliek/wcs?) met o.a.
landgebruikskaart versie 2013, 2016 en 2019.

Voorbeeld 500 m x 500 m uitsnede van landgebruikskaart 2019 [@poelmans2021]:
...
Voorbeeld inlezen volledig vito landgebruikskaart 2019:
...
Voorbeeld inlezen volledig inbo landgebruikskaart 2016:
(kleurenschema ontbreekt nog)
...
-   Landbouw gedefinieerd als hokken met \> 70% landbouw
...
Jaar waarin bezoek werd gepland, inclusief recall + aanduiding of het effectief werd uitgevoerd:
